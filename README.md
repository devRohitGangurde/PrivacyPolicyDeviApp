...
<head>
  ...
  <title>Privacy Policy | Durga Aarti Sangrah – Audio</title>
  <meta name="description" content="Privacy Policy for the Durga Aarti Sangrah – Audio app. We do not collect personal data or location information." />
  <style>
    :root{
      --bg:#0f172a;       /* slate-900 */
      --card:#0b1226;     /* deep indigo mix */
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      background: radial-gradient(1200px 800px at 10% 0%, #18223e, var(--bg)) fixed;
    ...
    .logo{
      ...
      background:conic-gradient(from 210deg at 50% 50%, #fde68a, #f59e0b, #b45309, #fde68a);
    ...
    .card{
      ...
      border-radius:24px; padding:28px; box-shadow:0 8px 30px rgba(0,0,0,.25);
      backdrop-filter:saturate(120%) blur(6px);
    }

    h2{font-size:1.25rem;margin:28px 0 12px}
    h3{font-size:1.05rem;margin:20px 0 10px;color:var(--muted)}
    p{margin:10px 0}
  ...
  <div class="wrap">
    ...
    <div class="card">
      ...
      <section id="third-party">
        ...
        <p>
          The app does not integrate third‑party advertising SDKs or analytics that collect personal data. If we add any third‑party services in the future, this policy will be updated to describe what data (if any) they process and why.
        </p>
      </section>
      ...
      <section id="children">
        ...
        <p>
          Our app may be used by people of all ages and does not collect personal data from anyone, including children under 13 (or the age required by your jurisdiction).
        </p>
      </section>
